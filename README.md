...
- [Classic Algorithms](https://github.com/andrei-cacio/learning-rust#classic-algorithms)
- [Graph](https://github.com/andrei-cacio/learning-rust#graph)
- [Data Structures](https://github.com/andrei-cacio/learning-rust#data-structures)
- [Text](https://github.com/andrei-cacio/learning-rust#text)
- [Networking](https://github.com/andrei-cacio/learning-rust#networking)
- [Classes](https://github.com/andrei-cacio/learning-rust#classes)
- [Threading](https://github.com/andrei-cacio/learning-rust#threading)
- [Web](https://github.com/andrei-cacio/learning-rust#web)
- [Files](https://github.com/andrei-cacio/learning-rust#files)
- [Databases](https://github.com/andrei-cacio/learning-rust#databases)
- [Graphics and Multimedia](https://github.com/andrei-cacio/learning-rust#graphics-and-multimedia)
- [Security](https://github.com/andrei-cacio/learning-rust#security)
...
[**Fibonacci Sequence**](./projects/fibonacci_sequence) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Bandwidth Monitor**](./projects/network_monitor) - A small utility program that tracks how much data you have uploaded and downloaded from the net during the course of your current online session. See if you can find out what periods of the day you use more and less and generate a report or graph that shows it.
